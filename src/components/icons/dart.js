export default function DartIcon({ className }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" width="443px" height="138.46px" viewBox="0 0 443 138.46" enableBackground="new 0 0 443 138.46" xml:space="preserve">
            <g>
                ...
                <g>
                    ...
                    <path opacity="0.2" fill="#FFFFFF" enableBackground="new    " d="M32.55,110.39c-3.58-3.59-4.47-7.13-4.47-13.42V25.38    l-0.89-0.89v72.48C27.18,103.26,27.18,105,32.55,110.39l2.68,2.68l0,0L32.55,110.39z"/>
                    <polygon opacity="0.2" fill="#263238" enableBackground="new    " points="139.04,56.7 139.04,112.18 114.88,112.18     115.77,113.08 139.93,113.08 139.93,57.59   "/>
                    <path opacity="0.2" fill="#FFFFFF" enableBackground="new    " d="M111.3,28.96c-4.44-4.44-8.07-4.47-13.42-4.47H27.19l0.89,0.89    h69.8C100.55,25.38,107.29,24.93,111.3,28.96L111.3,28.96z"/>
