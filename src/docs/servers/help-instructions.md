...
::title[چرا پچیم به شکل خودکار آپگرید nginx را انجام نمی‌دهد؟]
...
اگر سرور شما دارای فایروال خارجی، برای مثال فایروال دیتاسنتر است لطفا مطمئن شوید [IP های پچیم](/getting-started/introduction#آدرس-ipهای-پچیم) در لیست سفید فایروال شما قرار دارد.
